...
move_up_sound = pygame.mixer.Sound("sounds/whip.wav")
move_down_sound = pygame.mixer.Sound("sounds/shoot.wav")
collision_sound = pygame.mixer.Sound("sounds/explode.wav")
